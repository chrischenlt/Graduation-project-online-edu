...
import com.clt.service.trade.service.WxPayService;
import com.clt.service.trade.util.StreamUtils;
import com.clt.service.trade.util.WxPayProperties;
...
public class ApiWeixinPayController {
    ...
    public R createNative(@PathVariable String orderNo, HttpServletRequest request){
        ...
        Map<String, Object> map = wxPayService.createNative(orderNo, remoteAddr);
    ...
    public String wxNotify(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        //验签：验证签名是否正确
        if(WXPayUtil.isSignatureValid(notifyXml, wxPayProperties.getPartnerKey())){
            ...
            if("SUCCESS".equals(notifyMap.get("result_code"))){
                ...
                if(order != null && order.getTotalFee().intValue() == Integer.parseInt(totalFee)){
                    ...
                    // todo 分布式下有并发问题，考虑用redisson实现DCL

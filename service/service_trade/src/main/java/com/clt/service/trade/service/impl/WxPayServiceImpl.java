...
public class WxPayServiceImpl implements WxPayService {
    ...
    public Map<String, Object> createNative(String orderNo, String remoteAddr) {
        ...
        try {
            ...
            params.put("appid", wxPayProperties.getAppId());//公众号id
            params.put("mch_id", wxPayProperties.getPartner());//商户号
            ...
            params.put("notify_url", wxPayProperties.getNotifyUrl());//通知地址（回调地址）
